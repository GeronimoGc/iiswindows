...
!(function (t, e) {
    ...
    var dt = {
            ...
            _parseFont: function (t) {
                ...
                return (
                    (n.string = (function (t) {
                        return !t ||
                            G.isNullOrUndef(t.size) ||
                            G.isNullOrUndef(t.family)
                            ? null
                            : (t.style ? t.style + ' ' : '') +
                                  (t.weight ? t.weight + ' ' : '') +
                                  t.size +
            ...
            draw: function () {
                ...
                for (
                    this._loop && s.length && s.push(s[0]),
                        ...
                        o.setLineDash &&
                            o.setLineDash(a.borderDash || d.borderDash),
                        o.lineDashOffset = Ct(
                            a.borderDashOffset,
                            d.borderDashOffset
                        ),
            ...
            for (
                a.borderWidth = n.getMaxBorderWidth(),
                    ...
                    n.innerRadius = Math.max(
                        n.outerRadius - a.radiusLength * p,
                        0
                    ),
                    e = 0,
                    i = c.length;
            ...
            for (e = 0, i = t.length; e < i; ++e)
                (a = t[e]),
                    'inner' !==
                        ...
                        ((s = r.borderWidth),
                        (d =
                            (l = r.hoverBorderWidth) > (d = s > d ? s : d)
                                ? l
                                : d))
            return d
        },
    ...
    st._set('pie', ut.clone(st.doughnut)),
        st._set('pie', { cutoutPercentage: 0 })
    var re = $t,
                ...
                return (
                    this._plugins.concat(a.plugins || []).forEach(function (t) {
                        if (-1 === i.indexOf(t)) {
                            ...
                            !1 !== a &&
                                (!0 === a &&
                                    (a = ut.clone(st.global.plugins[e])),
                                i.push(t),
    ...
    var Ze = pt.extend({
            ...
            getTitle: function () {
                var t = this._options.callbacks,
                    ...
                    a = []
                return (
                    (a = Ye(a, Ue(e))), (a = Ye(a, Ue(i))), (a = Ye(a, Ue(n)))
                )
            },
    ...
    ut.extend(ni.prototype, {
        ...
        updateDataset: function (t) {
            ...
            !1 !== Ee.notify(this, 'beforeDatasetUpdate', [i]) &&
                (e.controller.update(),
                Ee.notify(this, 'afterDatasetUpdate', [i]))
        },
        render: function (t) {
            var e = this
            ;(t && 'object' == typeof t) ||
    ...
    var fi = pt.extend({
            ...
            calculateTickRotation: function () {
                ...
                if (n.length && t.options.display && t.isHorizontal())
                    for (
                        ...
                        if (
                            ((r = Math.cos(u)), Math.sin(u) * s > t.maxHeight)
                        ) {
                            o--
                            break
                        }
            ...
            fit: function () {
                ...
                if (a.display && s) {
                    ...
                    if (
                        ((t._maxLabelLines = v), (t.longestLabelWidth = m), d)
                    ) {
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                        ...
                        ;(o = Math.ceil(g / p) - Math.floor(f / p)) > d &&
                            ...
                            s &&
                                (!vi(u) &&
                                    ut.almostWhole(u / p, p / 1e3) &&
                                    (n = u),
                                !vi(h) &&
                                    ut.almostWhole(h / p, p / 1e3) &&
                                    (a = h)),
                            (o = (a - n) / p),
                ...
                if (
                    ...
                    ut.each(n, function (n, a) {
                        var r = i.getDatasetMeta(a),
                            l = [
                                r.type,
                                void 0 === e.stacked && void 0 === r.stack
                                    ? a
                                    : '',
                                r.stack,
                            ].join('.')
            ...
            getPixelForValue: function (t) {
                ...
                return (
                    ...
                    t !== n &&
                        (0 === n &&
                            ((e -= h =
                                wi(s.fontSize, st.global.defaultFontSize)),
                            (n = u)),
                        ...
                        (function (t, e, i, n, a) {
                            ...
                            for (o = qi.length - 1; o >= qi.indexOf(i); o--)
                                if (
                                    ((r = qi[o]),
                                    ji[r].common &&
                                        t._adapter.diff(a, n, r) >= e.length)
                                )
                                    return r
                ...
                if (((a.font = o.string), d)) {
                    ...
                    ;(a.textAlign = 'left'),
                        ...
                        ut.each(t.legendItems, function (t, e) {
                            var n =
                                fn(i, r) + r / 2 + a.measureText(t.text).width
                            ;(0 === e ||
                                u[u.length - 1] + n + i.padding > l.width) &&
                                ((h += r + i.padding),
    ...
    (function () {
        ...
        ;(ut.where = function (t, e) {
            ...
            (ut.getRelativePosition = function (t, e) {
                ...
                return {
                    x: (i = Math.round(
                        (((i - r.left - l) / c) * o.width) /
                            e.currentDevicePixelRatio
                    )),
                    y: (n = Math.round(
                        (((n - r.top - d) / f) * o.height) /
                            e.currentDevicePixelRatio
                    )),
                }
            }),
