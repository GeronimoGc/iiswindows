...
;(function (global, factory) {
  ...
  compute it */
        ...
        _parseFont: function (options) {
            ...
            var font = {
                ...
                lineHeight: helpers_core.options.toLineHeight(
                    valueOrDefault(
                        options.lineHeight,
                        globalDefaults.defaultLineHeight
                    ),
                    size
                ),
                size: size,
        ...
        for (i = 0, ilen = keys.length; i < ilen; ++i) {
            ...
            if (type === typeof origin) {
                if (type === 'string') {
                    ...
                    helpers$1.isFinite(origin) &&
                    helpers$1.isFinite(target)
                ) {
    ...
    helpers$1.extend(Element.prototype, {
        ...
        hasValue: function () {
            return (
                helpers$1.isNumber(this._model.x) &&
                helpers$1.isNumber(this._model.y)
            )
        },
    })
    ...
    var core_animations = {
        ...
        requestAnimationFrame: function () {
            ...
            if (me.request === null) {
                ...
                me.request = helpers$1.requestAnimFrame.call(
                    window,
                    function () {
                        me.request = null
                        me.startDigest()
    ...
    var element_arc = core_element.extend({
        ...
        draw: function () {
            ...
            ctx.arc(
                vm.x,
                vm.y,
                Math.max(vm.outerRadius - pixelMargin, 0),
                sA,
                eA
            )
    ...
    var controller_doughnut = core_datasetController.extend({
        ...
        getMaxBorderWidth: function (arcs) {
            ...
            for (i = 0, ilen = arcs.length; i < ilen; ++i) {
                arc = arcs[i]
                options = controller
                    ? controller._resolveElementOptions(arc, i)
                    : arc._options
    ...
    var controller_line = core_datasetController.extend({
        ...
        _resolveLineOptions: function (element) {
            ...
            values.spanGaps = valueOrDefault$5(
                dataset.spanGaps,
                options.spanGaps
            )
            values.tension = valueOrDefault$5(
                dataset.lineTension,
                elementOptions.tension
            )
            values.steppedLine = resolve$4([
                custom.steppedLine,
                dataset.steppedLine,
    ...
    var core_layouts = {
        ...
        update: function (chart, width, height) {
            ...
            var verticalBoxWidth =
                (width - chartAreaWidth) / verticalBoxes.length
            ...
            function fitBox(box) {
                var minBoxSize = helpers$1.findNextWhere(
                    minBoxSizes,
                    function (minBox) {
            ...
            var leftPaddingAddition = Math.max(
                maxPadding.left - outerBoxSizes.left,
                0
            )
            outerBoxSizes.left += leftPaddingAddition
            outerBoxSizes.right += Math.max(
                maxPadding.right - outerBoxSizes.right,
                0
            )

            var topPaddingAddition = Math.max(
                maxPadding.top - outerBoxSizes.top,
                0
            )
            outerBoxSizes.top += topPaddingAddition
            outerBoxSizes.bottom += Math.max(
                maxPadding.bottom - outerBoxSizes.bottom,
                0
            )
            ...
            var newMaxChartAreaHeight =
                height - outerBoxSizes.top - outerBoxSizes.bottom
            var newMaxChartAreaWidth =
                width - outerBoxSizes.left - outerBoxSizes.right
            ...
            function placeBox(box) {
                if (box.isHorizontal()) {
                    ...
                    box.right = box.fullWidth
                        ? width - rightPadding
                        : outerBoxSizes.left + maxChartAreaWidth
                    box.top = top
    ...
    function addResizeListener(node, listener, chart) {
        ...
        var resizer = (expando.resizer = createResizer(
            throttled(function () {
                if (expando.resizer) {
                    var container =
                        chart.options.maintainAspectRatio && node.parentNode
    ...
    var core_scaleService = {
        ...
        updateScaleDefaults: function (type, additions) {
            ...
            if (me.defaults.hasOwnProperty(type)) {
                me.defaults[type] = helpers$1.extend(
                    me.defaults[type],
                    additions
                )
            }
        ...
        nearest: function (elements, eventPosition) {
            ...
            for (i = 0, len = elements.length; i < len; ++i) {
                ...
                if (el && el.hasValue()) {
                    ...
                    var d = helpers$1.distanceBetweenPoints(
                        eventPosition,
                        center
                    )
    ...
    function getBaseModel(tooltipOpts) {
        ...
        return {
            ...
            _bodyFontFamily: valueOrDefault$7(
                tooltipOpts.bodyFontFamily,
                globalDefaults.defaultFontFamily
            ),
            _bodyFontStyle: valueOrDefault$7(
                tooltipOpts.bodyFontStyle,
                globalDefaults.defaultFontStyle
            ),
            _bodyAlign: tooltipOpts.bodyAlign,
            bodyFontSize: valueOrDefault$7(
            ...
            _titleFontFamily: valueOrDefault$7(
                tooltipOpts.titleFontFamily,
                globalDefaults.defaultFontFamily
            ),
            _titleFontStyle: valueOrDefault$7(
                tooltipOpts.titleFontStyle,
                globalDefaults.defaultFontStyle
            ),
            titleFontSize: valueOrDefault$7(
            ...
            _footerFontFamily: valueOrDefault$7(
                tooltipOpts.footerFontFamily,
                globalDefaults.defaultFontFamily
            ),
            _footerFontStyle: valueOrDefault$7(
                tooltipOpts.footerFontStyle,
                globalDefaults.defaultFontStyle
            ),
            footerFontSize: valueOrDefault$7(
    ...
    helpers$1.extend(
        ...
        /** @lends Chart */ {
            ...
            buildOrUpdateScales: function () {
                ...
                if (options.scales) {
                    items = items.concat(
                        (options.scales.xAxes || []).map(function (
                            xAxisOptions
                        ) {
                            return {
                        ...
                        (options.scales.yAxes || []).map(function (
                            yAxisOptions
                        ) {
                            return {
                ...
                helpers$1.each(items, function (item) {
                    ...
                    var scaleType = valueOrDefault$8(
                        scaleOptions.type,
                        item.dtype
                    )
                ...
                helpers$1.each(
                    ...
                    function (dataset, datasetIndex) {
                        ...
                        if (meta.controller) {
                            ...
                            meta.controller = new ControllerClass(
                                me,
                                datasetIndex
                            )
            ...
            updateDataset: function (index) {
                ...
                if (
                    core_plugins.notify(me, 'beforeDatasetUpdate', [args]) ===
                    false
                ) {
                    return
                }
            ...
            draw: function (easingValue) {
                ...
                if (
                    core_plugins.notify(me, 'beforeDraw', [easingValue]) ===
                    false
                ) {
                    return
                }
            ...
            drawDatasets: function (easingValue) {
                ...
                if (
                    core_plugins.notify(me, 'beforeDatasetsDraw', [
                        easingValue,
                    ]) === false
                ) {
                    return
            ...
            drawDataset: function (index, easingValue) {
                ...
                if (
                    core_plugins.notify(me, 'beforeDatasetDraw', [args]) ===
                    false
                ) {
                    return
                }
            ...
            _drawTooltip: function (easingValue) {
                ...
                if (
                    core_plugins.notify(me, 'beforeTooltipDraw', [args]) ===
                    false
                ) {
                    return
                }
    ...
    var core_helpers = function () {
        ...
        helpers$1.splineCurve = function (
            firstPoint,
            middlePoint,
            afterPoint,
            t
        ...
        helpers$1.getRelativePosition = function (evt, chart) {
            ...
            var paddingLeft = parseFloat(
                helpers$1.getStyle(canvas, 'padding-left')
            )
            var paddingTop = parseFloat(
                helpers$1.getStyle(canvas, 'padding-top')
            )
    ...
    var core_ticks = {
        ...
        formatters: {
            ...
            logarithmic: function (tickValue, index, ticks) {
                var remain =
                    tickValue /
                    Math.pow(10, Math.floor(helpers$1.log10(tickValue)))
    ...
    var core_scale = core_element.extend({
        ...
        afterBuildTicks: function (ticks) {
            ...
            me.ticks =
                helpers$1.callback(me.options.afterBuildTicks, [
                    me,
                    me.ticks,
                ]) || me.ticks
            return ticks
        ...
        calculateTickRotation: function () {
            ...
            if (labels.length && me.options.display && me.isHorizontal()) {
                var originalLabelWidth = helpers$1.longestText(
                    context,
                    tickFont.string,
                    labels,
                    me.longestTextCache
        ...
        fit: function () {
            ...
            if (scaleLabelOpts.display && display) {
                ...
                var scaleLabelPadding = helpers$1.options.toPadding(
                    scaleLabelOpts.padding
                )
                var deltaHeight =
                    scaleLabelFont.lineHeight + scaleLabelPadding.height
            ...
            if (tickOpts.display && display) {
                var largestTextWidth = helpers$1.longestText(
                    me.ctx,
                    tickFont.string,
                    labels,
                    me.longestTextCache
                ...
                var tallestLabelHeightInLines =
                    helpers$1.numberOfLabelLines(labels)
                ...
                if (isHorizontal) {
                    ...
                    var offsetRight =
                        me.right - me.getPixelForTick(labels.length - 1)
                    ...
                    if (me.labelRotation !== 0) {
                        paddingLeft =
                            position === 'bottom'
                                ...
                                : cosRotation * lineSpace
                        paddingRight =
                            position === 'bottom'
                                ? cosRotation * lineSpace
                                : cosRotation * lastLabelWidth
                    } else {
                    ...
                    me.paddingRight =
                        Math.max(paddingRight - offsetRight, 0) + 3
                } else {
        ...
        _autoSkip: function (ticks) {
            ...
            if (tickCount > maxTicks) {
                skipRatio = Math.max(
                    skipRatio,
                    1 + Math.floor(tickCount / maxTicks)
                )
            }
        ...
        draw: function (chartArea) {
            ...
            var parseFont = helpers$1.options._parseFont
            var ticks =
                optionTicks.display && optionTicks.autoSkip
                    ? me._autoSkip(me.getTicks())
                    : me.getTicks()
            var tickFontColor = valueOrDefault$9(
                optionTicks.fontColor,
                defaultFontColor
            )
            var tickFont = parseFont(optionTicks)
            var lineHeight = tickFont.lineHeight
            var majorTickFontColor = valueOrDefault$9(
            ...
            var scaleLabelFontColor = valueOrDefault$9(
            ...
            helpers$1.each(ticks, function (tick, index) {
                ...
                if (
                    ...
                    lineWidth = valueAtIndexOrDefault(
                        gridLines.lineWidth,
                        index
                    )
                ...
                var lineValue = getPixelForGridLine(
                    me,
                    index,
                ...
                if (isHorizontal) {
                    ...
                    if (position === 'top') {
                        y1 =
                            alignPixel(chart, chartArea.top, axisWidth) +
                            axisWidth / 2
                        y2 = chartArea.bottom
                        textOffset =
                            ((!isRotated ? 0.5 : 1) - labelCount) * lineHeight
                        textAlign = !isRotated ? 'center' : 'left'
                        labelY = me.bottom - labelYOffset
                    } else {
                        y1 = chartArea.top
                        y2 =
                            alignPixel(chart, chartArea.bottom, axisWidth) -
                            axisWidth / 2
                    ...
                    if (position === 'left') {
                        x1 =
                            alignPixel(chart, chartArea.left, axisWidth) +
                            axisWidth / 2
                        x2 = chartArea.right
                        ...
                        x1 = chartArea.left
                        x2 =
                            alignPixel(chart, chartArea.right, axisWidth) -
                            axisWidth / 2
            ...
            if (axisWidth) {
                ...
                if (isHorizontal) {
                    x1 =
                        alignPixel(chart, me.left, firstLineWidth) -
                        firstLineWidth / 2
                    x2 =
                        alignPixel(chart, me.right, lastLineWidth) +
                        lastLineWidth / 2
                    y1 = y2 = borderValue
                } else {
                    y1 =
                        alignPixel(chart, me.top, firstLineWidth) -
                        firstLineWidth / 2
                    y2 =
                        alignPixel(chart, me.bottom, lastLineWidth) +
                        lastLineWidth / 2
                    x1 = x2 = borderValue
                }
        ...
        getLabelForIndex: function (index, datasetIndex) {
            ...
            if (
                chart
                    ...
                    .controller._getValueScaleId() === me.id
            ) {
    ...
    function generateTicks(generationOptions, dataRange) {
        ...
        var spacing =
            helpers$1.niceNum((rmax - rmin) / maxNumSpaces / unit) * unit
        ...
        if (numSpaces > maxNumSpaces) {
            ...
            spacing =
                helpers$1.niceNum((numSpaces * spacing) / maxNumSpaces / unit) *
                unit
        }
    ...
    var scale_linearbase = core_scale.extend({
        ...
        getTickLimit: function () {
            ...
            if (stepSize) {
                maxTicks =
                    Math.ceil(me.max / stepSize) -
                    Math.floor(me.min / stepSize) +
                    1
            } else {
                        ...
                        helpers$1.each(
                            ...
                            function (rawValue, index) {
                                ...
                                positiveValues[index] =
                                    positiveValues[index] || 0
                                negativeValues[index] =
                                    negativeValues[index] || 0
    ...
    function generateTicks$1(generationOptions, dataRange) {
        ...
        var tickVal = valueOrDefault$a(
            generationOptions.min,
            Math.pow(10, Math.floor(helpers$1.log10(dataRange.min)))
        )
        ...
        handleTickRangeOptions: function () {
            ...
            if (me.min === me.max) {
                if (me.min !== 0 && me.min !== null) {
                    me.min = Math.pow(
                        10,
                        Math.floor(helpers$1.log10(me.min)) - 1
                    )
                    me.max = Math.pow(
                        10,
                        Math.floor(helpers$1.log10(me.max)) + 1
                    )
                } else {
                    me.min = DEFAULT_MIN
                    me.max = DEFAULT_MAX
            ...
            if (me.minNotZero === null) {
                if (me.min > 0) {
                    ...
                    me.minNotZero = Math.pow(
                        10,
                        Math.floor(helpers$1.log10(me.max))
                    )
                } else {
    ...
    function drawPointLabels(scale) {
        ...
        var lineWidth = valueOrDefault$b(
            angleLineOpts.lineWidth,
            gridLineOpts.lineWidth
        )
        var lineColor = valueOrDefault$b(
            angleLineOpts.color,
            gridLineOpts.color
        )
    ...
    function drawRadiusLine(scale, gridLineOpts, radius, index) {
        ...
        var lineWidth = valueAtIndexOrDefault$1(
            gridLineOpts.lineWidth,
            index - 1
        )
        var pointPosition
    ...
    var scale_radialLinear = scale_linearbase.extend({
        ...
        setCenterPoint: function (
            ...
            var me = this
            var maxRight = me.width - rightmlovement - me.drawingArea
            ...
            if (opts.display) {
                ...
                helpers$1.each(me.ticks, function (label, index) {
                    ...
                    if (index > 0 || tickOpts.reverse) {
                        ...
                        if (tickOpts.display) {
                            var tickFontColor = valueOrDefault$b(
                                tickOpts.fontColor,
                                core_defaults.global.defaultFontColor
                            )
    ...
    function determineUnitForFormatting(scale, ticks, minUnit, min, max) {
        ...
        for (i = ilen - 1; i >= UNITS.indexOf(minUnit); i--) {
            ...
            if (
                ...
                scale._adapter.diff(max, min, unit) >= ticks.length
            ) {
                return unit
            }
        }
        ...
        if (options.offset && ticks.length) {
            if (!options.time.min) {
                ...
                if (ticks.length === 1) {
                    ...
                    start =
                        (interpolate$1(table, 'time', ticks[1], 'pos') -
                            first) /
                        2
                }
            }
    ...
    function ticksFromTimestamps(scale, values, majorUnit) {
        ...
        for (i = 0, ilen = values.length; i < ilen; ++i) {
            value = values[i]
            major = majorUnit
                ? value === +scale._adapter.startOf(value, majorUnit)
                : false
    ...
    var scale_time = core_scale.extend({
        ...
        determineDataLimits: function () {
            ...
            max =
                max === MIN_INTEGER ? +adapter.endOf(Date.now(), unit) + 1 : max
        ...
        tickFormatFunction: function (time, index, ticks, format) {
            ...
            var formatter = valueOrDefault$c(
                tickOpts.callback,
        ...
        getPixelForOffset: function (time) {
            ...
            var offset =
                (size * (me._offsets.start + pos)) /
                (me._offsets.start + 1 + me._offsets.end)
        ...
        getValueForPixel: function (pixel) {
            ...
            var pos =
                (size ? (pixel - start) / size : 0) *
                    (me._offsets.start + 1 + me._offsets.start) -
                me._offsets.end
        ...
        getLabelWidth: function (label) {
            ...
            var tickFontSize = valueOrDefault$c(
                ticksOpts.fontSize,
                core_defaults.global.defaultFontSize
            )
        ...
        ;(function (global, factory) {
            ...
            function weekOfYear(mom, dow, doy) {
                var weekOffset = firstWeekOffset(mom.year(), dow, doy),
                    week =
                        Math.floor((mom.dayOfYear() - weekOffset - 1) / 7) + 1,
                    resWeek,
                    resYear
    ...
    core_defaults._set('global', {
        legend: {
            ...
            labels: {
                ...
                generateLabels: function (chart) {
                    var data = chart.data
                    return helpers$1.isArray(data.datasets)
                        ? data.datasets.map(function (dataset, i) {
                              return {
                                  text: dataset.label,
                                  fillStyle: !helpers$1.isArray(
    ...
    var Legend = core_element.extend({
                ...
                if (isHorizontal) {
                    ...
                    helpers$1.each(me.legendItems, function (legendItem, i) {
                        ...
                        if (
                            ...
                            lineWidths[lineWidths.length - (i > 0 ? 0 : 1)] =
                                labelOpts.padding
                        }
        ...
        draw: function () {
            ...
            if (opts.display) {
                var ctx = me.ctx
                var fontColor = valueOrDefault$d(
                    labelOpts.fontColor,
                ...
                var drawLegendBox = function (x, y, legendItem) {
                    ...
                    var lineWidth = valueOrDefault$d(
                        legendItem.lineWidth,
                        lineDefault.borderWidth
                    )
                    ctx.fillStyle = valueOrDefault$d(
                        legendItem.fillStyle,
                        defaultColor
                    )
                    ctx.lineCap = valueOrDefault$d(
                        legendItem.lineCap,
                        lineDefault.borderCapStyle
                    )
                    ctx.lineDashOffset = valueOrDefault$d(
                        legendItem.lineDashOffset,
                        lineDefault.borderDashOffset
                    )
                    ctx.lineJoin = valueOrDefault$d(
                        legendItem.lineJoin,
                        lineDefault.borderJoinStyle
                    )
                    ctx.lineWidth = lineWidth
                    ctx.strokeStyle = valueOrDefault$d(
                ...
                helpers$1.each(me.legendItems, function (legendItem, i) {
                    ...
                    if (isHorizontal) {
                        if (
                            ...
                            x = cursor.x =
                                me.left +
                                (legendWidth - lineWidths[cursor.line]) / 2 +
                                labelOpts.padding
                        }
                    } else if (
                        i > 0 &&
                        y + itemHeight > me.top + me.minSize.height
                    ) {
                        x = cursor.x =
    ...
    var Title = core_element.extend({
        ...
        fit: function () {
            ...
            var textSize = display
                ? lineCount * fontOpts.lineHeight + opts.padding * 2
                : 0
