...
!(function (t, e) {
    ...
    var U,
        ...
        q = {
            ...
            _mergerIf: function (t, e, i) {
                var n = e[t],
                    a = i[t]
                q.isObject(n) && q.isObject(a)
                    ? q.mergeIf(n, a)
                    : e.hasOwnProperty(t) || (e[t] = q.clone(a))
            },
    ...
    ut.extend(_t.prototype, {
        ...
        setHoverStyle: function (t) {
            ...
            ;(t.$previousStyle = {
                ...
                (a.borderColor = yt(
                    [n.hoverBorderColor, e.hoverBorderColor, r(a.borderColor)],
                    void 0,
                    i
                )),
                (a.borderWidth = yt(
                        ...
                        0 === t
                            ...
                            : ((i = -1 === d ? i : s[d]),
                              n.skip ||
                                  ((d !== t - 1 && !o) || -1 === d
                                      ? r.moveTo(n.x, n.y)
                                      : ut.canvas.lineTo(r, i._view, e._view),
                                  (d = t)))
                r.stroke(), r.restore()
            },
        }),
    ...
    function Lt(t, e, i) {
        var n,
            ...
            l = (function (t) {
                ...
                return e
                    ? (t.horizontal
                          ? t.base > t.x && (e = Rt(e, 'left', 'right'))
                          : t.base < t.y && (e = Rt(e, 'bottom', 'top')),
                      (i[e] = !0),
                      i)
                    : i
            })(t)
            ...
            callbacks: {
                ...
                label: function (t, e) {
                    var i = e.labels[t.index],
                        n = ': ' + e.datasets[t.datasetIndex].data[t.index]
                    return (
                        ut.isArray(i) ? ((i = i.slice())[0] += n) : (i += n), i
                    )
                },
            },
        },
    ...
    var Xt = kt.extend({
                ...
                var p = o.rotation % (2 * Math.PI),
                    v =
                        (p +=
                            2 *
                            Math.PI *
                            (p >= Math.PI ? -1 : p < -Math.PI ? 1 : 0)) + g,
                    y = { x: Math.cos(p), y: Math.sin(p) },
                    b = { x: Math.cos(v), y: Math.sin(v) },
                    x =
                        (p <= 0 && v >= 0) ||
                        (p <= 2 * Math.PI && 2 * Math.PI <= v),
                    _ =
                        (p <= 0.5 * Math.PI && 0.5 * Math.PI <= v) ||
                        (p <= 2.5 * Math.PI && 2.5 * Math.PI <= v),
                    k =
                        (p <= -Math.PI && -Math.PI <= v) ||
                        (p <= Math.PI && Math.PI <= v),
                    w =
                        (p <= 0.5 * -Math.PI && 0.5 * -Math.PI <= v) ||
                        (p <= 1.5 * Math.PI && 1.5 * Math.PI <= v),
                    M = f / 100,
                    S = {
                        x: k
                            ? -1
            ...
            for (
                a.borderWidth = n.getMaxBorderWidth(),
                    ...
                    n.innerRadius = Math.max(
                        n.outerRadius - a.radiusLength * m,
                        0
                    ),
                    e = 0,
                    i = c.length;
        ...
        updateElement: function (t, e, i) {
            ...
            ut.extend(t, {
                ...
                _model: {
                    ...
                    outerRadius: m,
                    innerRadius: g,
                    label: ut.valueAtIndexOrDefault(
                        c.label,
                        e,
                        a.data.labels[e]
                    ),
        ...
        getMaxBorderWidth: function (t) {
            ...
            if (!t)
                for (e = 0, i = d.data.datasets.length; e < i; ++e)
                    if (d.isDatasetVisible(e)) {
                        ;(t = (n = d.getDatasetMeta(e)).data),
                            e !== this.index && (r = n.controller)
                        break
                    }
            if (!t) return 0
            for (e = 0, i = t.length; e < i; ++e)
                (a = t[e]),
                    'inner' !==
                        (o = r ? r._resolveElementOptions(a, e) : a._options)
                            .borderAlign &&
                        ((s = o.borderWidth),
                        (u =
                    ...
                    for (t = 0, e = l.length; t < e; ++t)
                        (i = l[t]._model),
                            te(i, s) &&
                                (t > 0 &&
                                    te(l[t - 1]._model, s) &&
                                    ((i.controlPointPreviousX = u(
                                        i.controlPointPreviousX,
                                        s.left,
                                        s.right
                                    )),
                                    (i.controlPointPreviousY = u(
                                ...
                                t < l.length - 1 &&
                                    te(l[t + 1]._model, s) &&
                                    ((i.controlPointNextX = u(
                                        i.controlPointNextX,
                                        s.left,
                                        s.right
                                    )),
                                    (i.controlPointNextY = u(
                                        i.controlPointNextY,
                                        s.top,
                                        s.bottom
                                    ))))
    ...
    var ae = kt.extend({
        ...
        update: function (t) {
            ...
            for (e = 0, i = d.length; e < i; ++e)
                (d[e]._options = a._resolveElementOptions(d[e], e)),
        ...
        updateBezierControlPoints: function () {
            ...
            for (t = 0, e = o.length; t < e; ++t)
                (i = o[t]._model),
                    ...
                    (i.controlPointPreviousX = s(
                        n.previous.x,
                        r.left,
                        r.right
                    )),
                    (i.controlPointPreviousY = s(
                        n.previous.y,
                        r.top,
                        r.bottom
                    )),
    ...
    function We(t, e, i) {
        var n,
            ...
            l = (s.resizer = (function (t) {
                ...
                return (
                    Ae(i, 'scroll', a.bind(i, 'expand')),
                    Ae(n, 'scroll', a.bind(n, 'shrink')),
                    e
                )
            })(
                ((n = function () {
                ...
                i && i.canvas === t
                    ? ((function (t, e) {
                          ...
                          if (null === n || '' === n)
                              if ('' === t.style.height)
                                  t.height =
                                      t.width / (e.options.aspectRatio || 2)
                              else {
                                  var o = Oe(t, 'height')
                                  void 0 !== r && (t.height = o)
                              }
                ...
                return (
                    this._plugins.concat(a.plugins || []).forEach(function (t) {
                        if (-1 === i.indexOf(t)) {
                            ...
                            !1 !== a &&
                                (!0 === a &&
                                    (a = ut.clone(ot.global.plugins[e])),
                                i.push(t),
    ...
    var Xe = gt.extend({
            ...
            getTitle: function () {
                var t = this._options.callbacks,
                    ...
                    a = []
                return (
                    (a = Ue(a, Ge(e))), (a = Ue(a, Ge(i))), (a = Ue(a, Ge(n)))
                )
            },
            ...
            e.scales &&
                ...
                ut.each(n, function (e) {
                    var n = e.options,
                        r = n.id,
                        o = Qe(n.type, e.dtype)
                    ii(n.position) !== ii(e.dposition) &&
                        (n.position = e.dposition),
                        (a[r] = !0)
                    var s = null
                    if (r in i && i[r].type === o)
                        ((s = i[r]).options = n), (s.ctx = t.ctx), (s.chart = t)
                    else {
                ...
                ut.each(
                    ...
                    function (i, n) {
                        ...
                        if (
                            (a.type &&
                                a.type !== r &&
                                (t.destroyDatasetMeta(n),
                                (a = t.getDatasetMeta(n))),
                            (a.type = r),
                            a.controller)
                        )
                            a.controller.updateIndex(n),
                                a.controller.linkScales()
                        else {
                            var o = ue[a.type]
                            if (void 0 === o)
                                throw new Error(
                                    '"' + a.type + '" is not a chart type.'
                                )
            ...
            if (!1 !== He.notify(e, 'beforeRender')) {
                var r = function (t) {
                    He.notify(e, 'afterRender'),
                        ut.callback(i && i.onComplete, [t], e)
                }
                if (i && n) {
                    var o = new pt({
                        numSteps: n / 16.66,
    ...
    var fi = gt.extend({
            ...
            afterBuildTicks: function (t) {
                ...
                return ut.isArray(t) && t.length
                    ...
                    : ((e.ticks =
                          ut.callback(e.options.afterBuildTicks, [
                              e,
                              e.ticks,
                          ]) || e.ticks),
                      t)
            ...
            calculateTickRotation: function () {
                ...
                if (n.length && t.options.display && t.isHorizontal())
                    for (
                        ...
                        if (
                            ((o = Math.cos(d)), Math.sin(d) * s > t.maxHeight)
                        ) {
                            r--
                            break
                        }
            ...
            fit: function () {
                ...
                if (a.display && s) {
                    ...
                    if (
                        ((t._maxLabelLines = v), (t.longestLabelWidth = p), u)
                    ) {
                        var x = ut.toRadians(t.labelRotation),
                            _ = Math.cos(x),
                            k = Math.sin(x) * p + h.lineHeight * v + y
                        ;(e.height = Math.min(t.maxHeight, e.height + k + b)),
                            (t.ctx.font = h.string)
                        var w,
                            M,
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                        ...
                        ;(r = Math.ceil(g / m) - Math.floor(f / m)) > u &&
                            ...
                            s &&
                                (!vi(d) &&
                                    ut.almostWhole(d / m, m / 1e3) &&
                                    (n = d),
                                !vi(h) &&
                                    ut.almostWhole(h / m, m / 1e3) &&
                                    (a = h)),
                            (r = (a - n) / m),
                            (r = ut.almostEquals(r, Math.round(r), m / 1e3)
                                ? Math.round(r)
                                : Math.ceil(r)),
                            (n = Math.round(n * i) / i),
                            (a = Math.round(a * i) / i),
                ...
                if (
                    ...
                    ut.each(n, function (n, a) {
                        var o = i.getDatasetMeta(a),
                            l = [
                                o.type,
                                void 0 === e.stacked && void 0 === o.stack
                                    ? a
                                    : '',
                                o.stack,
                            ].join('.')
    ...
    var wi = {
        position: 'left',
        ticks: { callback: li.formatters.logarithmic },
    }
    function Mi(t, e) {
    ...
    var Si = fi.extend({
                        ...
                        ut.each(s, function (e) {
                            if (e.length > 0) {
                                var i = ut.min(e),
                                    n = ut.max(e)
                                ;(t.min =
                                    null === t.min ? i : Math.min(t.min, i)),
                                    (t.max =
                                        null === t.max ? n : Math.max(t.max, n))
                            }
                        })
                } else
                    ut.each(n, function (e, n) {
                ...
                ;(t.min = Mi(e.min, t.min)),
                    ...
                    t.min === t.max &&
                        (0 !== t.min && null !== t.min
                            ? ((t.min = Math.pow(
                                  10,
                                  Math.floor(ut.log10(t.min)) - 1
                              )),
                              (t.max = Math.pow(
                                  10,
                                  Math.floor(ut.log10(t.max)) + 1
                              )))
                            : ((t.min = 1), (t.max = 10))),
                    null === t.min &&
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                        var i,
                            ...
                            r = ki(
                                t.min,
                                Math.pow(10, Math.floor(ut.log10(e.min)))
                            ),
            ...
            getPixelForValue: function (t) {
                ...
                return (
                    (t = +o.getRightValue(t)),
                    l
                        ? ((n = o.end), (a = o.start), (r = -1))
                        : ((n = o.start), (a = o.end), (r = 1)),
                    o.isHorizontal()
                    ...
                    t !== n &&
                        (0 === n &&
                            ((e -= h =
                                ki(s.fontSize, ot.global.defaultFontSize)),
                            (n = d)),
    ...
    function Ai(t) {
        ...
        return e.display && t.display
            ? Ci(e.fontSize, ot.global.defaultFontSize) + 2 * e.backdropPaddingY
            : 0
    }
    ...
    var Ni = yi.extend({
            ...
            setReductions: function (t, e, i) {
                var n = this,
                    ...
                    o = -e.t / Math.cos(i.t),
                    s =
                        -Math.max(e.b - (n.height - n.paddingTop), 0) /
                        Math.cos(i.b)
                ;(a = Yi(a)),
                    (r = Yi(r)),
                    (o = Yi(o)),
    ...
    function Zi(t, e) {
        ...
        return (
            ...
            ut.isFinite(o) ||
                (o = 'string' == typeof r ? i.parse(o, r) : i.parse(o)),
            null !== o
                ? +o
                : (a ||
                      'function' != typeof r ||
                      ((o = r(e)), ut.isFinite(o) || (o = i.parse(o))),
                  o)
        )
    }
    function $i(t, e) {
        ...
        for (
            d ||
                (d = (function (t, e, i, n) {
                    ...
                    for (
                        a = 0, r = d.length;
                        a < r && ((o = d[a]), !(Math.ceil(s / (u * o)) <= n));
                        ++a
                    );
                    return o
                })(e, i, l, n)),
                h &&
                    ((g = +r.startOf(g, 'isoWeek', h)),
                    (m = +r.startOf(m, 'isoWeek', h))),
                        ...
                        (function (t, e, i, n, a) {
                            ...
                            for (r = ji.length - 1; r >= ji.indexOf(i); r--)
                                if (
                                    ((o = ji[r]),
                                    Bi[o].common &&
                                        t._adapter.diff(a, n, o) >= e.length)
                                )
                                    return o
            ...
            ((function (t, e) {
                t.exports = (function () {
                    ...
                    function b(t) {
                        v(this, t),
                            (this._d = new Date(
                                null != t._d ? t._d.getTime() : NaN
                            )),
                            this.isValid() || (this._d = new Date(NaN)),
                            !1 === y &&
                                ((y = !0), n.updateOffset(this), (y = !1))
                    }
                    function x(t) {
                        return (
                            t instanceof b ||
                    ...
                    B('Y', 0, 0, function () {
                        ...
                        ft('YYYY', function (t, e) {
                            e[pt] =
                                2 === t.length ? n.parseTwoDigitYear(t) : k(t)
                        }),
                        ft('YY', function (t, e) {
                    ...
                    function Yt(t) {
                        return null != t
                            ? (Wt(this, t), n.updateOffset(this, !0), this)
                            : Ot(this, 'Month')
                    }
                    var Nt = st,
                        zt = st
                    function Vt() {
                        ...
                        for (
                            n.sort(t), a.sort(t), r.sort(t), e = 0;
                            e < 12;
                            e++
                        )
                                ...
                                for (
                                    ...
                                    (r = a[e]),
                                        (i = (s.match(dt(r, t)) || [])[0]) &&
                                            ...
                                            (s = s.slice(
                                                s.indexOf(i) + i.length
                                            )),
                                            (u += i.length)),
                                        E[r]
                                            ? (i
                                                  ? (f(t).empty = !1)
                                                  : f(t).unusedTokens.push(r),
                                              mt(r, i, t))
                                            : t._strict &&
                                              !i &&
                                              f(t).unusedTokens.push(r)
                    ...
                    function Re(t, e) {
                        var i, n
                        if (
                            (1 === e.length && a(e[0]) && (e = e[0]), !e.length)
                        )
                            return Ie()
                    ...
                    function $e(t, e) {
                        ...
                        return (
                            (i.months =
                                ...
                                t.month() +
                                12 * (e.year() - t.year())),
                            t.clone().add(i.months, 'M').isAfter(e) &&
                                --i.months,
                            (i.milliseconds =
                                +e - +t.clone().add(i.months, 'M')),
                            i
                        )
                    }
                    function Xe(t, e) {
                    ...
                    function ui(t, e, i) {
                        return t < 100 && t >= 0
                            ? new Date(t + 400, e, i) - si
                            : new Date(t, e, i).valueOf()
                    }
                    function di(t, e, i) {
                        return t < 100 && t >= 0
                            ? Date.UTC(t + 400, e, i) - si
                            : Date.UTC(t, e, i)
                    }
                    function hi(t, e) {
                        B(0, [t, t.length], 0, e)
                    ...
                    ;(bi.add = Je),
                        (bi.calendar = function (t, e) {
                            ...
                            return this.format(
                                o || this.localeData().calendar(r, this, Ie(i))
                            )
                        }),
                        (bi.clone = function () {
                            return new b(this)
                    ...
                    ;(_i.calendar = function (t, e, i) {
                        ...
                        (_i.pastFuture = function (t, e) {
                            var i =
                                this._relativeTime[t > 0 ? 'future' : 'past']
                        ...
                        (_i.monthsParse = function (t, e, i) {
                            ...
                            for (
                                ...
                                if (
                                    ...
                                    i &&
                                        'MMMM' === e &&
                                        this._longMonthsParse[n].test(t))
                                )
                                    return n
                                if (
                                    i &&
                                    'MMM' === e &&
                                    this._shortMonthsParse[n].test(t)
                                )
                                    return n
                        ...
                        (_i.monthsRegex = function (t) {
                            return this._monthsParseExact
                                ? (d(this, '_monthsRegex') || Vt.call(this),
                                  t
                                      ? this._monthsStrictRegex
                                      : this._monthsRegex)
                                : (d(this, '_monthsRegex') ||
                                      (this._monthsRegex = zt),
                        ...
                        (_i.weekdaysParse = function (t, e, i) {
                            ...
                            if (this._weekdaysParseExact)
                                return function (t, e, i) {
                                    ...
                                    return i
                                        ...
                                        : 'dddd' === e
                                        ? -1 !==
                                          (a = Ct.call(this._weekdaysParse, o))
                                            ? a
                                            : -1 !==
                                              (a = Ct.call(
                                                  this._shortWeekdaysParse,
                            ...
                            for (
                                ...
                                if (
                                    ...
                                    i &&
                                        'dddd' === e &&
                                        this._fullWeekdaysParse[n].test(t))
                                )
                                    return n
                                if (
                                    i &&
                                ...
                                if (
                                    i &&
                                    'dd' === e &&
                                    this._minWeekdaysParse[n].test(t)
                                )
                                    return n
                ...
                if (((a.font = r.string), u)) {
                    ...
                    ;(a.textAlign = 'left'),
                        ...
                        ut.each(t.legendItems, function (t, e) {
                            var n =
                                mn(i, o) + o / 2 + a.measureText(t.text).width
                            ;(0 === e ||
                                d[d.length - 1] + n + i.padding > l.width) &&
                                ((h += o + i.padding),
                                (d[d.length - (e > 0 ? 0 : 1)] = i.padding)),
                                (s[e] = {
                                    left: 0,
                                    top: 0,
                                    width: n,
                    ...
                    ut.each(t.legendItems, function (t, e) {
                        ...
                        e > 0 &&
                            p + v > l.height - c &&
                            ((g += m + i.padding), f.push(m), (m = 0), (p = 0)),
                            (m = Math.max(m, n)),
                            (p += v),
                ...
                ut.each(t.legendItems, function (n, d) {
                    ...
                    m
                        ? d > 0 &&
                          ...
                          ((b = l.y += p),
                          l.line++,
                          (y = l.x = t.left + (o - s[l.line]) / 2 + i.padding))
                        : d > 0 &&
                          b + p > t.top + t.minSize.height &&
                          ((y = l.x = y + t.columnWidths[l.line] + i.padding),
                          (b = l.y = t.top + i.padding),
                          l.line++),
                        (function (t, i, n) {
                            if (!(isNaN(f) || f <= 0)) {
                                u.save()
            ...
            beforeUpdate: function (t) {
                ...
                e
                    ? (ut.mergeIf(e, ot.global.legend),
                      i ? (xe.configure(t, i, e), (i.options = e)) : vn(t, e))
    ...
    var xn = gt.extend({
        ...
        fit: function () {
            ...
            t.isHorizontal()
                ? ((n.width = t.maxWidth), (n.height = o))
                : ((n.width = o), (n.height = t.maxHeight)),
                (t.width = n.width),
                (t.height = n.height)
        },
        afterFit: bn,
            ...
            beforeUpdate: function (t) {
                ...
                e
                    ? (ut.mergeIf(e, ot.global.title),
                      i ? (xe.configure(t, i, e), (i.options = e)) : _n(t, e))
    ...
    (function () {
        ...
        function i(i, n, a) {
            ...
            return u || d
                ? Math.min(u ? t(s, i, a) : h, d ? t(l, o, a) : h)
                : 'none'
        }
