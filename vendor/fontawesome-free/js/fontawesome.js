...
;(function () {
    ...
    function replaceForPosition(node, position) {
        ...
        return new picked(function (resolve, reject) {
            ...
            if (alreadyProcessedPseudoElement && !fontFamily) {
                ...
                var prefix = ~['Light', 'Regular', 'Solid', 'Brands'].indexOf(
                    fontFamily[1]
                )
                ...
                if (
                    ...
                    (!alreadyProcessedPseudoElement ||
                        alreadyProcessedPseudoElement.getAttribute(
                            DATA_PREFIX
                        ) !== prefix ||
                        alreadyProcessedPseudoElement.getAttribute(
                            DATA_ICON
    ...
    var text = function text(content) {
        ...
        var _params$transform2 = params.transform,
            ...
            attributes =
                _params$attributes2 === void 0 ? {} : _params$attributes2,
    ...
    var counter = function counter(content) {
        ...
        var _params$title3 = params.title,
            ...
            attributes =
                _params$attributes3 === void 0 ? {} : _params$attributes3,
