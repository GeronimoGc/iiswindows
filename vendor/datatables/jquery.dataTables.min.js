...
;(function (h) {
        ...
        var e = [],
            ...
            t = function (a, b) {
                if ('string' === typeof a) {
                    var c = a.indexOf('@')
                    ;-1 !== c &&
                        ((c = a.substring(c + 1)), N(a)(d, b.getAttribute(c)))
                }
            },
            G = function (a) {
                if (c === k || c === i)
    ...
    function ob(a) {
        ...
        for (
            var f = a.sDom.split(''), g, j, i, m, l, q, k = 0;
            k < f.length;
            k++
        ) {
            g = null
    ...
    function la(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k)
            ...
            u &&
                I(function (a, b) {
                    a.innerhtml =
                        '<div class="dataTables_sizing">' + A[b] + '</div>'
                    a.childNodes[0].style.height = '0'
                    a.childNodes[0].style.overflow = 'hidden'
                    a.style.width = y[b]
                }, R)
    ...
    function Fa(a) {
        ...
        for (n = 0; n < i.length; n++)
            (o = c[i[n]]),
                null !== o.sWidth &&
                    ((o.sWidth = Fb(o.sWidthOrig, k)), (t = !0))
        ...
        for (a = 0; a < m.length; a++) {
            ...
            for (c = f.length; b < c; b++)
                (g = f[b]),
                    (j = e[g].sType || 'string'),
                    m[a]._idx === k &&
                        (m[a]._idx = h.inArray(m[a][1], e[g].asSorting)),
                    d.push({
                        src: i,
                        col: g,
                        dir: m[a][1],
    ...
    function Ib(a, b) {
        ...
        for (
            var f,
                g = n.ext.type.order[c.sType + '-pre'],
                j = 0,
                i = a.aoData.length;
            j < i;
            j++
            ...
            b = function (b) {
                if (b && b.time) {
                    ...
                    if (
                        ...
                        b.search !== k &&
                            h.extend(a.oPreviousSearch, Cb(b.search))
                        if (b.columns) {
                            d = 0
                            for (e = b.columns.length; d < e; d++)
                                (g = b.columns[d]),
                                    g.visible !== k &&
                                        (f[d].bVisible = g.visible),
                                    g.search !== k &&
                                        h.extend(
                                            a.aoPreSearchCols[d],
                                            Cb(g.search)
