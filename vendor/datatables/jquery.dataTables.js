...
;(function (factory) {
        ...
        for (i = 0, ien = columns.length; i < ien; i++) {
            ...
            if (oSettings.oFeatures.bSort) {
                ...
                if (column.bSortable !== false) {
                    cell.attr('tabindex', oSettings.iTabIndex).attr(
                        'aria-controls',
                        oSettings.sTableId
                    )
    ...
    function _fnCallbackFire(settings, callbackArr, eventName, args) {
        ...
        if (callbackArr) {
            ret = $.map(
                settings[callbackArr].slice().reverse(),
                function (val, i) {
    ...
    var __details_add = function (ctx, row, data, klass) {
        ...
        var addRow = function (r, k) {
            ...
            if (r.nodeName && r.nodeName.toLowerCase() === 'tr') {
                ...
                $('td', created).addClass(k).html(r)[0].colSpan =
    ...
    $.each(['column', 'row', 'cell'], function (i, type) {
        _api_register(type + 's().every()', function (fn) {
            ...
            return this.iterator(
                type,
                function (settings, arg1, arg2, arg3, arg4) {
                    // Rows and columns:
                    //  arg1 - index
                    //  arg2 - table counter
                    //  arg3 - loop counter
            ...
            jqueryui: function (settings, cell, column, classes) {
                ...
                $(settings.nTable).on(
                    ...
                    function (e, ctx, sorting, columns) {
                        ...
                        cell.find('span.' + classes.sSortIcon)
                            .removeClass(
                                classes.sSortJUIAsc +
                                    ' ' +
