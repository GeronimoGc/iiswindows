...
!(function (e, t) {
    ...
    var h = (function (n) {
            ...
            function (e) {
                ...
                return (
                    r !== T &&
                        ...
                        (p.getElementsByClassName = J.test(
        ...
        (se.attr = function (e, t) {
            ...
            var n = x.attrHandle[t.toLowerCase()],
                r =
                    n && L.call(x.attrHandle, t.toLowerCase())
                        ? n(e, t, !E)
                        : void 0
            return void 0 !== r
                ? r
        ...
        function Ee(e) {
            for (
                ...
                if ((t = x.relative[e[s].type])) c = [xe(we(c), t)]
                    ...
                    if (
                        (t = x.filter[e[s].type].apply(null, e[s].matches))[N]
                    ) {
                        for (n = ++s; n < r; n++)
    ...
    function Ie(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            K.hasData(e) &&
                ((s = K.access(e)), (u = E.extend({}, s)), K.set(t, u))
        }
    }
    function Re(n, r, i, o) {
        r = y.apply([], r)
        ...
        if (
            ...
            if (s)
                for (
                    l = a[a.length - 1].ownerDocument, E.map(a, He), c = 0;
                    c < s;
                    c++
                )
                    (u = a[c]),
    ...
    E.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (
                        o = o || ge(e), a = a || ge(c), r = 0, i = o.length;
                        r < i;
                        r++
                    )
                        Ie(o[r], a[r])
        ...
        trigger: function (e, t, n, r) {
            ...
            if (
                ...
                3 !== n.nodeType &&
                    ...
                    ((e = e[E.expando]
                        ? e
                        : new E.Event(p, 'object' == typeof e && e)).isTrigger =
                        r ? 2 : 3),
                    (e.namespace = h.join('.')),
                ...
                while ((o = d[i++]) && !e.isPropagationStopped())
                    (f = o),
                        ...
                        (l =
                            (G.get(o, 'events') || {})[e.type] &&
                            G.get(o, 'handle')) && l.apply(o, t),
                        (l = u && o[u]) &&
                            l.apply &&
                            Q(o) &&
                    ...
                    r ||
                        ...
                        (u &&
                            ...
                            e.isPropagationStopped() &&
                                f.addEventListener(p, dt),
                            n[p](),
                            e.isPropagationStopped() &&
                                f.removeEventListener(p, dt),
