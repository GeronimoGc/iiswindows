...
;(function (window, undefined) {
    ...
    jQuery.support = (function () {
        ...
        jQuery(function () {
            ...
            paddingMarginBorderVisibility =
                paddingMarginBorder + '0;visibility:hidden;'
            style =
                "style='" +
                positionTopLeftWidthHeight +
                paddingMarginBorder +
            ...
            div.style.cssText =
                positionTopLeftWidthHeight + paddingMarginBorderVisibility
            div.innerhtml = html
    ...
    var rformElems = /^(?:textarea|input|select)$/i,
        ...
        quickParse = function (selector) {
            ...
            if (quick) {
                ...
                quick[3] =
                    quick[3] && new RegExp('(?:^|\\s)' + quick[3] + '(?:\\s|$)')
            }
            return quick
        },
    ...
    jQuery.event = {
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            if (!onlyHandlers && !special.noBubble && !jQuery.isWindow(elem)) {
                ...
                cur = rfocusMorph.test(bubbleType + type)
                    ? elem
                    : elem.parentNode
                old = null
                    ...
                    if (!seed && !Sizzle.isXML(context)) {
                        ...
                        if (context.nodeType === 9) {
                            ...
                            var oldContext = context,
                                ...
                                relativeHierarchySelector = /^\s*[+~]/.test(
                                    query
                                )
        ...
        domManip: function (args, table, callback) {
            ...
            if (this[0]) {
                ...
                if (first) {
                    ...
                    for (
                        var i = 0, l = this.length, lastIndex = l - 1;
                        i < l;
                        i++
                    ) {
                        callback.call(
                    ...
                    if (!rhtml.test(elem)) {
                        ...
                        if (div) {
                            ...
                            if (safeChildNodes.length > 0) {
                                remove =
                                    safeChildNodes[safeChildNodes.length - 1]
    ...
    function getWidthOrHeight(elem, name, extra) {
            ...
            if (extra !== 'border') {
                for (; i < len; i += 2) {
                    if (!extra) {
                        val -=
                            parseFloat(
                                jQuery.css(elem, 'padding' + cssExpand[i])
                            ) || 0
                    }
                    if (extra === 'margin') {
                        val +=
        ...
        if (extra) {
            for (; i < len; i += 2) {
                val +=
                    parseFloat(jQuery.css(elem, 'padding' + cssExpand[i])) || 0
                if (extra !== 'padding') {
                    val +=
                        parseFloat(
                            jQuery.css(elem, 'border' + cssExpand[i] + 'Width')
                        ) || 0
                }
                if (extra === 'margin') {
                    val +=
                        parseFloat(jQuery.css(elem, extra + cssExpand[i])) || 0
                }
            }
        }
    ...
    function ajaxConvert(s, response) {
        ...
        for (i = 1; i < length; i++) {
            ...
            if (current === '*') {
                ...
                if (!(conv || conv2)) {
                    jQuery.error(
                        'No conversion from ' + conversion.replace(' ', ' to ')
                    )
                }
