    ...
    Test.prototype = {
        ...
        hooks: function (handler) {
            ...
            function processHooks(test, module) {
                ...
                if (
                    module.testEnvironment &&
                    QUnit.objectType(module.testEnvironment[handler]) ===
                        'function'
                ) {
                    hooks.push(
                        test.queueHook(module.testEnvironment[handler], handler)
                    )
                }
            }
        ...
        valid: function () {
            ...
            function moduleChainIdMatch(testModule) {
                return (
                    inArray(testModule.moduleId, config.moduleId) > -1 ||
...
*/
    ...
    QUnit.assert = Assert.prototype = {
        ...
        push: function (result, actual, expected, message, negative) {
            var currentAssert =
                this instanceof Assert ? this : QUnit.config.current.assert
...
;(function () {
    ...
    function applyUrlParams() {
        ...
        selectedModule = modulesList
            ? decodeURIComponent(
                  modulesList.options[modulesList.selectedIndex].value
              )
            : undefined
    ...
    function toolbarModuleFilterhtml() {
        ...
        moduleFilterhtml +=
            ...
            (QUnit.urlParams.module === undefined
                ? "selected='selected'"
                : '') +
            '>< All Modules ></option>'
        ...
        for (i = 0; i < modulesList.length; i++) {
            moduleFilterhtml +=
                ...
                "' " +
                (QUnit.urlParams.module === modulesList[i]
                    ? "selected='selected'"
                    : '') +
                '>' +
    ...
    function getNamehtml(name, module) {
        ...
        if (module) {
            namehtml =
                "<span class='module-name'>" + escapeText(module) + '</span>: '
        }
    ...
    QUnit.log(function (details) {
        ...
        message =
            escapeText(details.message) || (details.result ? 'okay' : 'failed')
        ...
        if (!details.result && hasOwn.call(details, 'expected')) {
            ...
            if (actual !== expected) {
                ...
                if (
                    !/^(true|false)$/.test(actual) &&
                    !/^(true|false)$/.test(expected)
                ) {
                    diff = QUnit.diff(expected, actual)
                    showDiff =
                        striphtml(diff).length !==
        ...
        DiffMatchPatch.prototype.diffBisect = function (
            ...
            for (d = 0; d < maxD; d++) {
                ...
                for (k1 = -d + k1start; k1 <= d - k1end; k1 += 2) {
                    ...
                    if (
                        k1 === -d ||
                        (k1 !== d && v1[k1Offset - 1] < v1[k1Offset + 1])
                    ) {
                        x1 = v1[k1Offset + 1]
                    } else {
                        x1 = v1[k1Offset - 1] + 1
                ...
                for (k2 = -d + k2start; k2 <= d - k2end; k2 += 2) {
                    ...
                    if (
                        k2 === -d ||
                        (k2 !== d && v2[k2Offset - 1] < v2[k2Offset + 1])
                    ) {
                        x2 = v2[k2Offset + 1]
                    } else {
                        x2 = v2[k2Offset - 1] + 1
